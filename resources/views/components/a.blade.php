...
<a {{ $attributes->class([
            ...
            // No Outline
            'bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-800 text-gray-700 border-gray-300' => !$secondary && !$outline && $color == 'white',
            'bg-sky-700 hover:bg-sky-800 focus:ring-sky-800 text-white' => !$secondary && !$outline && $color == 'sky',
            ...
            // Outline
            'border-sky-700 hover:bg-sky-700 hover:text-white focus:ring-sky-800 text-sky-700' => !$secondary && $outline && $color == 'sky',
            ...
            // Secondary Buttons
            'bg-sky-100 hover:bg-sky-200 focus:ring-sky-800 text-sky-700' => $secondary && $color == 'sky',
