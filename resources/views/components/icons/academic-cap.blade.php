...
@if($outline)
    <svg {{ $attributes }} x-description="Heroicon name: outline/academic-cap" xmlns="http://www.w3.org/2000/svg"
...
@else
    <svg {{ $attribtues }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path
